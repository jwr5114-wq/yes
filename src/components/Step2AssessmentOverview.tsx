    ...
    <div className="space-y-5">
      ...
      <div className="border-2 border-blue-200 rounded-xl p-4 bg-blue-50/40 space-y-3">
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <div className="flex items-center gap-1.5 required-teacher-box">
          ...
          <div className="p-4 bg-white border border-slate-200 rounded-lg text-xs space-y-3 shadow-sm">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <div className="flex items-center border border-slate-300 rounded-md bg-white px-2 required-teacher-input">
                  <input
                    type="number"
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="점"
                  className="w-full p-2 border rounded-md border-slate-300 focus:ring-2 focus:ring-blue-500 outline-none required-teacher-input"
                />
            ...
            <div className="p-3 bg-blue-50/50 rounded-lg border border-blue-200/80 space-y-1.5">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 p-2 text-xs bg-white border border-slate-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none font-medium text-slate-800 shadow-xs required-teacher-input"
                />
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-2 border rounded-md border-slate-300 bg-slate-50 text-slate-600 cursor-not-allowed required-teacher-input"
              />
            </div>
          </div>
        )}
      ...
      <div className="border-2 border-emerald-200 rounded-xl p-4 bg-emerald-50/40 space-y-3">
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <div className="flex items-center gap-1.5 flex-wrap required-teacher-box">
              <span className="text-xs font-bold text-slate-700">횟수</span>
              {[1, 2, 3, 4].map((cnt) => (
                <button
                  key={cnt}
            ...
            <div key={num} className="p-4 bg-white border border-emerald-200 rounded-lg text-xs space-y-3 shadow-sm">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border rounded-md border-slate-300 focus:ring-2 focus:ring-emerald-500 outline-none font-medium required-teacher-input"
                />
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    placeholder="예: 탐구형"
                    className="w-full p-2 border rounded-md border-slate-300 focus:ring-2 focus:ring-emerald-500 outline-none required-teacher-input"
                  />
                </div>
                <div>
              ...
              <div className="p-3 bg-emerald-50/50 rounded-lg border border-emerald-200/80 space-y-1.5">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 p-2 text-xs bg-white border border-slate-300 rounded-md focus:ring-2 focus:ring-emerald-500 outline-none font-medium text-slate-800 shadow-xs required-teacher-input"
                  />
                  <span className="text-slate-400 font-bold text-sm">~</span>
                  <input
                    type="date"
